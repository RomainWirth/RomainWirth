# 01 - Introduction a l'algorithmique

## Qu'est-ce que l'algorithmique ?

L'algorithmique est la discipline qui consiste a concevoir, decrire, analyser et ameliorer des algorithmes.

Un algorithme est une suite finie d'instructions ordonnees permettant de resoudre un probleme ou d'accomplir une tache.
...
Un programme informatique est une implementation concrete d'un ou plusieurs algorithmes dans un langage de programmation.
...
Avant d'ecrire du code, il faut clarifier le probleme.

### Etapes classiques

1. Identifier le besoin.
2. Definir les donnees d'entree.
3. Definir le resultat attendu.
4. Decouper le probleme en sous-problemes.
5. Ecrire une version simple en pseudo-code.
6. Verifier que chaque etape est utile, ordonnee et finie.

## Le pseudo-code

Le pseudo-code est une maniere de decrire un algorithme sans dependre d'un langage particulier.
...
## Ce qu'on attend d'un bon algorithme
