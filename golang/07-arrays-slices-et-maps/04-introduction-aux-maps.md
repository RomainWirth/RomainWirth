...
- Une `map` stocke des paires **clé/valeur** : `map[typeClé]typeValeur{clé: valeur, ...}`.
- Accès : `mapName[clé]` ; ajout/modification : `mapName[clé] = valeur` ; suppression : `delete(mapName, clé)`.
