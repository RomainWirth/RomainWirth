...
> C'est pour cette raison que `fmt.Scan()` prend toujours ses arguments avec `&` : elle a besoin de l'adresse pour pouvoir écrire la valeur saisie directement dans la variable.
