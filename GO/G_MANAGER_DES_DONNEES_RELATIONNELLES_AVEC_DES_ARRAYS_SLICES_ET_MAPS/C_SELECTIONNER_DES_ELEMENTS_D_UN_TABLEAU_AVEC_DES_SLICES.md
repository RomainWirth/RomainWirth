...
> En pratique, les slices sont beaucoup plus utilisées que les arrays en Go. Un array sert surtout de socle mémoire sur lequel s'appuient les slices.
...
* On a uniquement un espace mémoire alloué au tableau, et la slice est une référence à une partie de ce tableau.
* Slice est donc une manière efficace de sélectionner des parties d'un tableau et même de les éditer.
...
- La slice est un mécanisme efficace en mémoire : un seul espace alloué, partagé par toutes les slices dérivées.
